This will be our nonexhaustive todo list for Rproxy v6.x.x and above. Release for production will be v8.x.x and above.

## Priority

- [ ] Make Rproxy work on Firefox (requires downloading malware to test :()
...
- Rammerhead is now locally built into the Rproxy repository
- Simplified the Rproxy setup process and added more default npm commands
